...
class General_model extends CI_Model
{
	...
	/**
	 * Recupera registros de una tabla especificada donde las columnas coinciden con las condiciones dadas.
	 *
	 * @param string $table El nombre de la tabla a consultar.
	 * @param array|string $conditions Un array asociativo de pares columna-valor para coincidir usando LIKE,
	 *                                 o una cadena en el formato "columna LIKE 'valor'".
	 * @param array $positions Opcional. Un array de posiciones para usar en la consulta.
	 * @return array El conjunto de resultados como un array de registros.
	 */
